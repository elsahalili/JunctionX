...
<section id="courses" class="courses section">
  <div class="container">
    ...
    <div class="row">
      <!-- Course Item 1 -->
      <div class="col-lg-4 col-md-6 d-flex align-items-stretch course-card" data-aos="zoom-in" data-aos-delay="100">
        <div class="course-item">
          <img src="assets/img/course-1.jpg" class="img-fluid" alt="...">
          <div class="course-content">
            <h3><a href="course-details.php">Website Design</a></h3>
            <p class="description">
              Learn how to create modern, responsive websites from scratch using HTML, CSS, and JavaScript.
            </p>
          </div>
        </div>
      </div>
      ...
      <!-- Course Item 2 -->
      <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0 course-card" data-aos="zoom-in" data-aos-delay="200">
        <div class="course-item">
          <img src="assets/img/course-2.jpg" class="img-fluid" alt="...">
          <div class="course-content">
            <h3><a href="course-details.php">Search Engine Optimization</a></h3>
            <p class="description">
              Master SEO techniques to improve your website's visibility on search engines like Google.
            </p>
          </div>
        </div>
      </div>
      ...
      <!-- Course Item 3 -->
      <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0 course-card" data-aos="zoom-in" data-aos-delay="300">
        <div class="course-item">
          <img src="assets/img/course-3.jpg" class="img-fluid" alt="...">
          <div class="course-content">
            <h3><a href="course-details.php">Copywriting</a></h3>
            <p class="description">
              Discover the art of persuasive writing to drive traffic, sales, and engagement.
            </p>
          </div>
        </div>
      </div>
