...
<body>
    ...
    <script>
        ...
        // Ema's automatic replies
        setTimeout(() => receiveMessage("Ema: Hey there! 🌸"), 2000);
        setTimeout(() => receiveMessage("Ema: What's up with you today?"), 8000);
        setTimeout(() => receiveMessage("Ema: Want to grab bubble tea later? 🧋"), 15000);
        setTimeout(() => receiveMessage("Ema: Meet me at 5 near the park 💕"), 25000);
    </script>
</body>
</html>
